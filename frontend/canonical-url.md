...
Добавьте в файл __Layout.cshtml_ в самое начало код:
```
@{
    //Каноническая ссылка
...
• Присутствие URL в файле Sitemap. Если вы используете карту сайта, то включите туда все канонические url, в точности так, как на странице. И наоборот, не включайте в файл Sitemap неканонические страницы.  
